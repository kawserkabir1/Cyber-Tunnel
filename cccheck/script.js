...
checkBtn.addEventListener("click", function () {
  ...
  for (let i = 0; i < numberArray.length; i++) {
    ...
    if (randomNumber < 0.2) {
      aliList.push(`<span class="greeny" style='color:#4caf50; font-weight:bold;'>Live</span> | ${line} -> [Charge <span style='color:#4caf50; font-weight:bold;'>$4,99</span>] [GATE:01].  / K4BIR`);
    } else if (randomNumber < 0.9) {
      muhammadList.push(`<span style='color:red; font-weight:bold;'>Dead</span> | ${line} -> [Charge <span style='color:red; font-weight:bold;'>$0,00</span>] [GATE:01].  / K4BIR`);
    } else {
      muradList.push(`<span style='color:orange; font-weight:bold;'>Unknown</span> | ${line} -> [Charge <span style='color:orange; font-weight:bold;'>N/A</span>] [GATE:01].  / K4BIR`);
    }
  } 
...
copyButtons.forEach(function (button) {
  button.addEventListener("click", function () {
    ...
    span.style.fontFamily = "Barlow Condensed";
